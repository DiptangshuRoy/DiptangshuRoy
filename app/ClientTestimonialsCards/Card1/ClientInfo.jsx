...
function ClientInfo({ name, role, avatarSrc }) {
  return (
    <header className="flex gap-10 items-center">
      ...
      <Image className="flex shrink-0 w-12 h-12 rounded-[50px]" src='/ClientPhotos/User2.png' height={100} width={100} aria-hidden="true" alt="" />
        <div>
          <h2 className="text-base leading-7">Michael Brown</h2>
