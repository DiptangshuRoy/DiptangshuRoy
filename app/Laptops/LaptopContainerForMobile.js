      ...
      <section className='m-24
        ...
        <div className='flex justify-center items-center 
          ...
          <div className='flex flex-col justify-center items-center text-center'>
            ...
            <div className='mt-2 flex gap-2 items-center'>
              ...
              {/* <Link className='transition hover:scale-110' href='https://my-netflix-clone-two.vercel.app/'>
        ...
        <div className='flex justify-center items-center mt-8
          ...
          <Link className='mr-5' href="https://space-x-clone-kohl.vercel.app/">
            <Image className='hover:scale-105 transition ' src='/Laptops/SpaceX.png' height={1700} width={1700} alt='SpaceX' />
          </Link>
        ...
        <div className='flex justify-center items-center
          ...
          <Link className='ml-5' href="https://to-do-list-app-gilt-two.vercel.app/">
            <Image className='hover:scale-105 transition ' src='/Laptops/iTask.png' height={1700} width={1700} alt='iTask' />
          </Link>
        ...
        <div className='flex justify-center items-center mt-8
          ...
          <Link className='mr-5' href="https://my-twitter-clone-mu.vercel.app/">
            <Image className='hover:scale-105 transition ' src='/Laptops/Twitter.png' height={1700} width={1700} alt='Twitter' />
          </Link>
