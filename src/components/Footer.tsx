  ...
  return (
    <footer className="border-t">
      <div className="container flex flex-col justify-between gap-2 sm:flex-row py-3.5 w-full shrink-0 items-center px-4 md:px-6">
        ...
        <span className="text-sm text-gray-400 max-md:hidden">Diptangshu Roy © 2023</span>

        <nav className="sm:ml-auto flex gap-4">
          <Link
            href="https://github.com/DiptangshuRoy"
            target="_blank"
            aria-label="GitHub"
          >
          ...
          <Link
            href="https://x.com/DiptangshuRoy_"
            target="_blank"
        ...
        <span className="text-sm text-gray-400 md:hidden">Diptangshu Roy © 2023</span>
      </div>
    </footer>
  );
};
