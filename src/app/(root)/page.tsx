...
export default function Page() {
  ...
  return (
    <main className="relative overflow-hidden">
        ...
        <div className="flex flex-col space-y-8">
          <div className="space-y-4">
            ...
            <p className="text-balance text-muted-foreground text-lg">
              Full-Stack Developer crafting high-performance, responsive, and
          ...
          <div className="flex gap-4">
            <Link href="mailto:diptangshuroybusiness@gmail.com" target="_blank">
      ...
      {/* Latset Projects */}
      <section id="projects" className="container py-12 md:py-24 scroll-mt-11">
      ...
      {/* Testimonials */}
      <section id="testimonials" className="container scroll-mt-20">
        <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl mb-12">
          Testimonials
        </h2>
        <Testimonials />
