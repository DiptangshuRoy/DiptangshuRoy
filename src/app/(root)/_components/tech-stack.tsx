...
const backEndAndToolsIcons = [...backEndTech, ...devTools].map((tech) => ({
  ...tech,
  icon: `https://cdn.simpleicons.org/${tech.slug}`,
}));
      ...
      <div className="flex gap-8">
        {items.map((tech, i) => (
          <div key={i} className="relative group text-center">
            <div
              className="w-20 h-20 border bg-gradient-to-b rounded-2xl p-6 transition-all duration-300 
...
const TechStack = () => {
  return (
    <div className="relative">
      ...
      <StackList items={backEndAndToolsIcons} />
    </div>
  );
};
