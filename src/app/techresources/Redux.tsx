  ...
  return (
    <Card className="relative max-w-[45vw] shadow-none max-md:max-w-[90vw]">
      ...
      <CardContent>
        ...
        <CardDescription>
          A powerful and predictable state management library for React — scale apps efficiently using centralized logic and modern Redux Toolkit patterns.
        </CardDescription>
      </CardContent>
      <CardFooter className="space-x-4">
        <Link href="https://redux.js.org/" target="_blank" className="rounded-lg">
